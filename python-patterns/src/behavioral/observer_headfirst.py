...
if __name__ == '__main__':
    ...
    currentDisplay.observe(weatherData)  # Observation　of weatherData Start
    statisticsDisplay.observe(weatherData)  # Observation　of weatherData Start
    forecastDisplay.observe(weatherData)  # Observation　of weatherData Start
    heatIndexDisplay.observe(weatherData)  # Observation　of weatherData Start
    weatherData.setMeasurements(80, 65, 30.4)  # Subjectを変化させる
    print()  # 空行の出力。
    weatherData.setMeasurements(82, 70, 29.2)  # Subjectを変化させる
    print()  # 空行の出力。
    weatherData.setMeasurements(78, 90, 29.2)  # Subjectを変化させる
